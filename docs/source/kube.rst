Scaling [tml-multi-agenticai-iot-3f10-3315-agenticai] With Kubernetes
===========================
...
Based on your TML solution [tml-multi-agenticai-iot-3f10-3315-agenticai] - if you want to scale your application with Kubernetes - you will need to apply the following YAML files.

.. list-table::

   * - **YML File**
     - **Description**
   * - :ref:`tml-multi-agenticai-iot-3f10-3315-agenticai.yml`
   ...
   * - :ref:`qdrant.yml`
     - This is the Qdrant deployment YAML.
       ...
       applied if using Step 9 DAG.
   * - :ref:`nginx-ingress-tml-multi-agenticai-iot-3f10-3315-agenticai.yml`
     - If you are scaling your TML solution you must

       apply the nginx-ingresstml-multi-agenticai-iot-3f10-3315-agenticai.yml; this yaml is 
...
.. code-block:: YAML
   ...
   kubectl apply -f kafka.yml -f secrets.yml -f mysql-storage.yml -f mysql-db-deployment.yml -f tml-multi-agenticai-iot-3f10-3315-agenticai.yml -f ollama.yml

tml-multi-agenticai-iot-3f10-3315-agenticai.yml
------------------------

.. important::
   Copy and Paste this YAML file: tml-multi-agenticai-iot-3f10-3315-agenticai.yml - and save it locally.

   These YML files can also be found on GitHub at: https://github.com/Bobbie101/raspberrypi/tree/main/tml-airflow/dags/tml-solutions/tml-multi-agenticai-iot-3f10-3315/ymls/tml-multi-agenticai-iot-3f10-3315-agenticai
...
.. code-block:: YAML
   ...
   ################# tml-multi-agenticai-iot-3f10-3315-agenticai.yml
     ...
     kind: Deployment
     metadata:
       name: tml-multi-agenticai-iot-3f10-3315-agenticai
     spec:
       selector:
         matchLabels:
           app: tml-multi-agenticai-iot-3f10-3315-agenticai
       ...
       template:
         ...
         spec:
           containers:
           - name: tml-multi-agenticai-iot-3f10-3315-agenticai
             image: Bobbie101/tml-multi-agenticai-iot-3f10-3315-agenticai-arm64:latest
             volumeMounts:
             - name: dockerpath
             ...
             - name: SOLUTIONNAME
               value: 'tml-multi-agenticai-iot-3f10-3315-agenticai'
             - name: SOLUTIONDAG
               value: 'solution_preprocessing_agenticai_dag-tml-multi-agenticai-iot-3f10-3315'
             - name: GITUSERNAME
               value: 'Bobbie101'
             - name: GITREPOURL
   ...
   ---
     ...
     kind: Service
     metadata:
       name: tml-multi-agenticai-iot-3f10-3315-agenticai-visualization-service
       labels:
         app: tml-multi-agenticai-iot-3f10-3315-agenticai-visualization-service
     spec:
       type: ClusterIP
       ports:
...
.. code-block::
   ...
   kubectl port-forward deployment/tml-multi-agenticai-iot-3f10-3315-agenticai 6060:6060
...
.. important::
   ...
   **STEP 4:  Apply nginx-ingress-tml-multi-agenticai-iot-3f10-3315-agenticai.yml to your kubernetes cluster.  First you need to save it locally then apply it:**

nginx-ingress-tml-multi-agenticai-iot-3f10-3315-agenticai.yml
-------------
   ...
   .. code-block::
      ...
      kubectl apply -f nginx-ingress-tml-multi-agenticai-iot-3f10-3315-agenticai.yml
