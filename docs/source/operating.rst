[tml-multi-agenticai-iot-3f10-3315-agenticai] Operating Details
====================================

Generated On: 2026-04-21 23:42:01 UTC
...
.. important::
   ...
   **not be valid if your [tml-multi-agenticai-iot-3f10-3315-agenticai] container is NOT running**.

.. tip::
   You must have your [tml-multi-agenticai-iot-3f10-3315-agenticai] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   Refer to the original solution container and documenation here: https://tml-multi-agenticai-iot-3f10-3315-agenticai.readthedocs.io/en/latest/operating.html
...
.. code-block::
   ...
   docker run -d --net=host -p 5050:5050 -p 4040:4040 -p 6060:6060 \
          --env TSS=0 \
          --env SOLUTIONNAME=tml-multi-agenticai-iot-3f10-3315-agenticai \
          --env SOLUTIONDAG=solution_preprocessing_agenticai_dag-tml-multi-agenticai-iot-3f10-3315 \
          ...
          Bobbie101/tml-multi-agenticai-iot-3f10-3315-agenticai-arm64
...
[tml-multi-agenticai-iot-3f10-3315-agenticai] Github Repo
---------------
...
.. important::
   https://tml-multi-agenticai-iot-3f10-3315-agenticai.readthedocs.io
...
.. important::
   solution_preprocessing_agenticai_dag-tml-multi-agenticai-iot-3f10-3315
...
.. important::
   VIPERHOST_PRODUCE=172.17.0.2, VIPERPORT_PRODUCE=5050, VIPERHOST_PREPOCESS=172.17.0.2, VIPERPORT_PREPROCESS=35851, VIPERHOST_PREPOCESS2=172.17.0.2, VIPERPORT_PREPROCESS2=41915, VIPERHOST_PREPOCESS_PGPT=172.17.0.2, VIPERPORT_PREPROCESS_PGPT=35059, VIPERHOST_ML=172.17.0.2, VIPERPORT_ML=39069, VIPERHOST_PREDCT=172.17.0.2, VIPERPORT_PREDICT=39267, HPDEHOST=172.17.0.2, HPDEPORT=40481, HPDEHOST_PREDICT=172.17.0.2, HPDEPORT_PREDICT=37869

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-2345-tml-multi-agenticai-iot-3f10-3315-agenticai,solution_preprocessing_agenticai_dag-tml-multi-agenticai-iot-3f10-3315, python-preprocess-4614-tml-multi-agenticai-iot-3f10-3315-agenticai,solution_preprocessing_agenticai_dag-tml-multi-agenticai-iot-3f10-3315, python-agenticai-9684-tml-multi-agenticai-iot-3f10-3315-agenticai,solution_preprocessing_agenticai_dag-tml-multi-agenticai-iot-3f10-3315, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-preprocess-agenticai, viper-ml, viper-predict
